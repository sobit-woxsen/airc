      ...
      <main className="flex-1 relative z-10 pt-32 pb-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <article className="mx-auto max-w-4xl">
            {/* Article Image */}
            <div className="relative mb-16 w-full overflow-hidden rounded-[2.5rem] border border-black/5 bg-neutral-100 shadow-2xl shadow-black/5 aspect-[21/9]">
            ...
            {/* Info Metrics */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-8 bg-white/50 backdrop-blur-sm rounded-3xl border border-black/5 mb-16 shadow-xl shadow-black/[0.02] relative overflow-hidden">
          ...
          {relatedArticles.length > 0 && (
            <div className="mt-40 pt-20 border-t border-black/5">
              <div className="flex items-end justify-between mb-12">
                <div>
                  <span className="text-[10px] font-semibold uppercase text-accent tracking-widest mb-2 block">Further Exploration</span>
                  <h2 className="text-3xl font-semibold tracking-tighter">Related Case Studies</h2>
                </div>
                <Link href="/insights" className="text-[10px] font-semibold uppercase tracking-widest text-black/40 hover:text-black flex items-center gap-2 transition-colors">
              ...
              <div className="grid md:grid-cols-2 gap-8 text-left">
                {relatedArticles.map((item, i) => (
                  <Link key={i} href={`/insights/${item.slug}`}>
                    <SpotlightCard
                      className="group rounded-[2rem] bg-white border border-black/5 overflow-hidden transition-all duration-500 hover:border-black/10 hover:shadow-xl hover:shadow-black/5"
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row h-full">
                        ...
                        <div className="p-8 sm:w-2/3">
                          ...
                          <span className="inline-flex items-center gap-2 text-[10px] font-semibold uppercase tracking-widest text-black/40 group-hover:text-black transition-colors">
